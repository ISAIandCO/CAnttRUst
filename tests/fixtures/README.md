...
`russian-trusted-root-ca.pem` — публичный корневой сертификат из
https://gu-st.ru/content/Other/doc/russiantrustedca.pem, получен 2026-09-10.
SHA-256 DER: `d26d2d0231b7c39f92cc738512ba54103519e4405d68b5bd703e9788ca8ecf31`.
Используется для проверки разбора набора CA, самоподписи и независимости DER-отпечатка от PEM-форматирования. Закрытых ключей нет.
